...
|  |  |  |
|-----------------|-----------------|-----------------|
| 오유찬    |  <img src="https://i.namu.wiki/i/4qLKxb0WiFRbid5wm4Dt5dNFlkZjGDNTvXrEo19EWE59o-GDUWyyHYRlpM8IRwkEdFd4xpochkypCsrgA35COA.webp" alt="오유찬" width="100"> | <ul><li>프로젝트 계획 및 관리</li><li>백엔드 배포 관리(무중단 배포)</li><li>리뷰 CRUD</li><li>장소 필터링</li><li>추천 시스템 로직 구현</li><li>리뷰 좋아요</li><li>반려견 등록 및 견종 검색</li><li>이미지 업로드</li></ul>     |
...
| 박종혁   |  <img src="https://fcseoulite.me/files/attach/images/192/288/604/010/36a3040967c668dc209899d2daa1969f.jpg" alt="박종혁" width="100">    |<ul><li>즐겨찾기</li><li>이메일 인증</li><li>회원가입</li><li>펫 CRUD</li><li>반려견 URD</li></ul>  |
